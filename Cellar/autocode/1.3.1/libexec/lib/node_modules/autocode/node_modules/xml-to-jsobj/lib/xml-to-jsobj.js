// ========================================================================
//  XML.xmlToJsObj -- XML  from/to JavaScript object 
// ========================================================================
...
XML.xmlToJsObj = function (args) {
    XML.isGetAttr = args["attr"]?args["attr"]:false;
    return this;
};

//  class variables

XML.xmlToJsObj.VERSION = "0.24";

//  object prototype

XML.xmlToJsObj.prototype.xmlDecl = '<?xml version="1.0" encoding="UTF-8" ?>\n';
XML.xmlToJsObj.prototype.attr_prefix = '-';
XML.xmlToJsObj.prototype.overrideMimeType = 'text/xml';

//  method: parseXML( xmlsource )

XML.xmlToJsObj.prototype.parseXML = function ( xml ) {
    var root;
...
XML.xmlToJsObj.prototype.parseHTTP = function ( url, options, callback ) {
    var myopt = {};
...
XML.xmlToJsObj.prototype.parseDOM = function ( root ) {
    if ( ! root ) return;
...
XML.xmlToJsObj.prototype.parseElement = function ( elem ) {
    //  COMMENT_NODE
    if ( elem.nodeType == 7 ) {
        return;
    }
    ...
    //  parse attributes
    if ( elem.attributes && elem.attributes.length && XML.isGetAttr) {
        retval = {};
...
XML.xmlToJsObj.prototype.addNode = function ( hash, key, cnts, val ) {
...
XML.xmlToJsObj.prototype.writeXML = function ( tree ) {
...
XML.xmlToJsObj.prototype.hash_to_xml = function ( name, tree ) {
    var elem = [];
    var attr = [];
    for( var key in tree ) {
...
XML.xmlToJsObj.prototype.array_to_xml = function ( name, array ) {
    var out = [];
...
XML.xmlToJsObj.prototype.scalar_to_xml = function ( name, text ) {
    if ( name == "#text" ) {
...
XML.xmlToJsObj.prototype.xml_escape = function ( text ) {
...
XML.xmlToJsObj -- XML source code from/to JavaScript object like E4X

=head1 SYNOPSIS

    var xotree = new XML.xmlToJsObj();
    var tree1 = {
        root: {
            node: "Hello, World!"
        }
...
XML.xmlToJsObj class is a parser/generater between XML source code
...
=head2 xotree = new XML.xmlToJsObj()

This constructor method returns a new XML.xmlToJsObj object.
...
exports.xmlToJsObj = XML.xmlToJsObj;
